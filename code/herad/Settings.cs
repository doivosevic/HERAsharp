...
namespace herad
{
    public static class Settings
    {
        ...
        public static string ReadsPath {
            get { return System.IO.Path.Combine(Folder, _ReadsPath); }
        ...
        {
            get { return System.IO.Path.Combine(Folder, _ContigsPath); }
        ...
        {
            get { return System.IO.Path.Combine(Folder, _ReadToReadPath); }
        ...
        {
            get { return System.IO.Path.Combine(Folder, _ReadToContigPath); }
        ...
        {
            get { return System.IO.Path.Combine(Folder, _ResultingFileName); }
